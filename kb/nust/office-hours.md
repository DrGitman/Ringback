...
The university switchboard is staffed during office hours only; outside of those hours, calls are not answered and there is no after-hours emergency line for administrative matters (as opposed to campus security, which operates separately around the clock).

If a student calls outside office hours or asks to speak to someone immediately, the honest answer is that no one from these offices is available until the next working day, and the right thing to do is note their question accurately so the correct office can follow up as soon as they're back, rather than promising an immediate response that can't be delivered.
